...
export const BraveWarningModal: FC<BraveWarningModalProps> = () => {
  ...
  return (
    <div className="text-fg-secondary flex w-full flex-col gap-4">
      <p className="text-fg-secondary [&>strong]:text-fg-primary px-4 text-xs">
        <Trans t={t}>
      ...
      <div className="text-fg-secondary flex w-full items-center justify-center gap-2 text-sm">
