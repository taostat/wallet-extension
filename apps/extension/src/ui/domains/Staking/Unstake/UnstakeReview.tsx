...
export const UnstakeReview = () => {
  ...
  return (
    <div className="flex size-full flex-col">
      <h2 className="mb-12 mt-4 text-center">{t("You are unstaking")}</h2>
      ...
      {!!errorMessage && (
        <div className="text-fg-orange bg-app-bg my-4 flex w-full items-center justify-center gap-2.5 rounded-sm px-2.5 py-3 text-xs">
