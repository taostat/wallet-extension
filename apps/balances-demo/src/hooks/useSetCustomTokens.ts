 ...
 *
 * For other dapps which use `@taostats-wallet/balances-react`, we might want to specify a custom list of tokens
 * to be fetched.
 *
 * This hook is an example of how to do just that.
 *
 * @example
 * // tell `@taostats-wallet/balances-react` that we want to fetch some
