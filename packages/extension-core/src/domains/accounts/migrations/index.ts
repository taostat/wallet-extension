...
export const LegacyAccountTypes = {
  TAOSTATS: "TAOSTATS", // mnemonic generated by Taostats Wallet
...
export const NewAccountTypes = {
  TAOSTATS: "TAOSTATS", // all accounts with locally stored private key
  QR: "QR",
  LEDGER: "LEDGER",
  DCENT: "DCENT",
  WATCHED: "WATCHED",
...
const accountOriginSwitch = (origin: LegacyAccountType): KeyringPair$Meta => {
  switch (origin) {
    case LegacyAccountTypes.TAOSTATS:
    ...
    case LegacyAccountTypes.SEED_STORED:
      return { origin: NewAccountTypes.TAOSTATS }
    case LegacyAccountTypes.JSON:
      return { origin: NewAccountTypes.TAOSTATS, importSource: "json" }
